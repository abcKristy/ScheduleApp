...
Spring Boot приложение для управления академическим расписанием с интеграцией внешнего API МИРЭА. Система предоставляет RESTful API для получения расписания занятий по группам, преподавателям и аудиториям с поддержкой многоуровневого кэширования и автоматическим обновлением данных.
...
- **JPA/Hibernate** - объектно-реляционное отображение
- **Реляционная БД** (H2/PostgreSQL/MySQL) - хранение данных
- **Миграции через JPA** - управление схемы БД
